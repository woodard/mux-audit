...
int main() {
    ...
    while (ext_debug != nullptr) {
        ...
        std::cout << "[main] Subtotal for Namespace " << ns_id << ": " << ns_total_tls << " bytes." << std::endl;
    ...
    std::cout << "[main] Grand Total TLS across all namespaces: " << grand_total_tls << " bytes." << std::endl;
    std::cout << "[main] ===============================================" << std::endl;
